            ...
            if ($file_error === 0){
                    if($file_size > 1000000){
                        ...
                        if(in_array($file_ex_lc,$allow_ex )){
                            ...
                            $file_upload_path = 'uploads/assigment/'.$new_file_name;
                            move_uploaded_file($file_tmp, $file_upload_path);
        
                            Database::iud("INSERT INTO `assigment`(`path`,`topic`,`subject`,`grade`) 
                            VALUES ('".$file_upload_path."','".$topic."','".$subject."','".$grade."')");
                          
                          echo("success");
                            // echo($file_upload_path);
                            header( "refresh:1;url=upload_assigmet.php");
                ...
                header( "refresh:1;url=upload_assigmet.php?error=$em");
