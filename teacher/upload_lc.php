    ...
    <div class="row">
      ...
      <div class="d-flex align-items-center justify-content-center vh-100 bg-light">
        <div class="col-lg-4 col-md-8 col-sm-12 shadow p-4">
          ...
          <h4>Upload Lecture notes </h4>

          <form action="ulc.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              <label for="exampleInputPassword1" class="form-label">lecture Topic</label>
